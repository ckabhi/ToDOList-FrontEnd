"use strict";(function($){$.isScrollToFixed=function(el){return!!$(el).data('ScrollToFixed')};$.ScrollToFixed=function(el,options){var base=this;base.$el=$(el);base.el=el;base.$el.data('ScrollToFixed',base);var isReset=!1;var target=base.$el;var position;var originalPosition;var originalFloat;var originalOffsetTop;var originalZIndex;var offsetTop=0;var offsetLeft=0;var originalOffsetLeft=-1;var lastOffsetLeft=-1;var spacer=null;var spacerClass;var className;function resetScroll(){target.trigger('preUnfixed.ScrollToFixed');setUnfixed();target.trigger('unfixed.ScrollToFixed');lastOffsetLeft=-1;offsetTop=target.offset().top;offsetLeft=target.offset().left;if(base.options.offsets){offsetLeft+=(target.offset().left-target.position().left)}
